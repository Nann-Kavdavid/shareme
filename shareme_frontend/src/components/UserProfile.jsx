...
const activBtnStyles = 'bg-red-500 text-white font-bold p-2 rounded-full w-20 outline-none'
                ...
                <div className='relative flex flex-col mb-7'>
                    ...
                    <div className='text-center mb-7'>
                        <button
                            ...
                            className={`${activeBtn === 'created' ? activBtnStyles : notActiveBtnStyles}`}
                        >
                            Created
                        </button>
                        <button
                            ...
                            className={`${activeBtn === 'saved' ? activBtnStyles : notActiveBtnStyles}`}
                        >
                            Saved
                        </button>
                    </div>
